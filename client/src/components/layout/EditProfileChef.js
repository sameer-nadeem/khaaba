        ...
        if (SaveAllow === false) {
            if (ProfileChangeFlag === true) {
                ...
                else if (LogoChangeFlag === true) //Profile and logo changed
                {
                    ...
                    if (logoFields.logo.size > 500000) {
                        ...
                        <div className="card-body">
                            ...
                            <form className="m-4">
                                ...
                                <div className="row justify-content-sm-center">
                                    ...
                                    {/* <img effect="blur" src={`http://localhost:3000/uploads/kitchen-logos/0e4b19f1-5c94-477d-86ab-ae994b5d34d6_Logo%20logo.jpgvvvvvvvv`} className="card-img-top upload-logo" alt="Logo" /> */}
